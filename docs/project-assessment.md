...
## Слабые стороны
- Безопасность API: дефолтный JWT_SECRET, нет проверки принадлежности вещей при обновлении/удалении (можно менять чужие записи), отсутствует валидация связей при создании образов/календаря и единый хендлинг ошибок.
